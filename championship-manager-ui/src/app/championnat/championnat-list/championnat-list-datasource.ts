 ...
 */
export class ChampionnatListDataSource extends DataSource<Championnat> {
  data: Championnat[] = [];
   ...
   */
  connect(): Observable<Championnat[]> {
   ...
   */
  private getPagedData(data: Championnat[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: Championnat[]) {
